...
_MARKET_SPEC = {
    ...
    "ASML": ("ASML Holding NV", "technology", 660.00, 645.20, 3_400_000),
}
...
# --- calls: 5 calls. Past calls (1-4) fully analyzed; last call (5, t=2026-06-19)
#     has computed fields left None for the pipeline to infer. -------------------
CALLS = [
    {
        "customer_id": 1,
        "call_date": "2023-05-12T10:00:00Z",
        "duration_seconds": 660,
        "channel": "phone",
        "transcript": (
            "RM: Dr. Keller, good to see you. The portfolio has had a solid year - Nestle and Roche steady, the US tech names strong.\n"
            "Client: Yes, I'm pleased. I'm a long-term investor, I don't like surprises, but the growth has been welcome.\n"
            "RM: Your allocation is balanced - Swiss blue chips, healthcare, a bit of US technology. Comfortable with that mix?\n"
            "Client: Very. Moderate risk suits me. I'd rather sleep well than chase the last few percent.\n"
            "RM: Understood. We'll keep the steady course and top up quality names on dips.\n"
            "Client: Good. Let's speak again in a few months."
        ),
        "summary": "Portfolio review; client comfortable with the balanced Swiss/healthcare/US-tech mix and his moderate risk stance.",
        "sentiment_score": 0.5,
        "sentiment_label": "positive",
        "risk_signal": "moderate",
        "topics": ["portfolio review", "balanced allocation", "long-term"],
    },
    {
        "customer_id": 1,
        "call_date": "2024-03-20T11:30:00Z",
        "duration_seconds": 540,
        "channel": "phone",
        "transcript": (
            "RM: Markets have been a little jumpy. How are you feeling?\n"
            "Client: Calm, mostly. Though I've been wondering whether I'm too concentrated in equities.\n"
            "RM: We could broaden into other real assets over time - property, perhaps some alternatives.\n"
            "Client: I like the idea of real assets. I already have the apartments. Maybe something beyond stocks and bonds.\n"
            "RM: We can explore that. For now the core stays intact.\n"
            "Client: Agreed. Keep it measured."
        ),
        "summary": "Client raises concentration in equities and an interest in broadening into real assets and alternatives.",
        "sentiment_score": 0.2,
    ...
    {
        "customer_id": 1,
        "call_date": "2025-01-15T14:00:00Z",
        ...
        "transcript": (
            ...
            "RM: They can be considered real assets. Let me look into how they're typically valued.\n"
            "Client: I'd appreciate that. I'd like to think more holistically about what I own.\n"
            "RM: We'll de-risk slightly and I'll come back on the collectibles question."
        ),
        "summary": "Volatility prompts mild de-risking; client first raises his art collection and wine cellar as possible wealth and asks how they are valued.",
        "sentiment_score": -0.1,
        "sentiment_label": "neutral",
        "risk_signal": "moderate",
    ...
    {
        "customer_id": 1,
        "call_date": "2025-11-10T09:30:00Z",
        "duration_seconds": 600,
        "channel": "phone",
        "transcript": (
            "RM: Given the volatility this autumn, I wanted to check in on positioning.\n"
            "Client: I'd like more stability. I'm not getting younger, and capital preservation matters more to me now.\n"
            ...
            "RM: Of course. We'll trim a little US tech and keep the quality Swiss names and healthcare.\n"
            "Client: Good. Stability and quality. That's where I am now."
        ),
        "summary": "Client shifts toward capital preservation and ESG; agrees to trim US tech while keeping quality Swiss names and healthcare.",
        "sentiment_score": -0.3,
    ...
    },
    {
        ...
        "channel": "video",
        "transcript": (
            "RM: Dr. Keller, thank you for the time. Markets have been turbulent - gold swinging around four thousand, energy elevated. How are you thinking about it?\n"
            "Client: Cautious, as you'd expect. I might want a little gold as a hedge. But that's not really why I called.\n"
            "RM: Go on.\n"
            "Client: Over the years I've quietly built a proper collection - paintings, a serious wine cellar, a few watches, and a classic car I restored. I've never treated any of it as part of my portfolio. With everything uncertain, I'm wondering whether these are real investments I should be managing properly.\n"
            "RM: That's an excellent question - passion assets are increasingly treated as part of a real-assets strategy.\n"
            "Client: Exactly. What are they actually worth as a class? How liquid are they, what does it cost to buy and sell, and do they hold up when markets fall?\n"
            "RM: Let me pull together proper information - market size, historical returns, transaction costs, and how they'd sit alongside your Swiss holdings and property.\n"
            "Client: Please. And if they're genuinely uncorrelated, perhaps they're the stability I've been looking for.\n"
            "RM: Understood. I'll prepare a full picture: a modest gold hedge, and a serious assessment of your art, wine, watches and the car as an asset class.\n"
            "Client: Thank you. This is exactly the kind of advice I value."
        ),
        "summary": None,
...
# --- risk_profile_history: onboarding -> t-1 ONLY (no point at the 2026-06-19
#     last call). Drifts from moderate (6.0) toward conservative (4.5) while the
#     stated profile stays "moderate" -> behavioral-drift signal. -----------------
RISK_PROFILE_HISTORY = [
    {"customer_id": 1, "assessed_date": "2019-03-15", "risk_appetite": "moderate", "risk_score": 6.0, "source": "onboarding", "note": "Initial onboarding assessment."},
    {"customer_id": 1, "assessed_date": "2023-05-12", "risk_appetite": "moderate", "risk_score": 6.0, "source": "call", "note": "Comfortable with balanced allocation."},
    {"customer_id": 1, "assessed_date": "2024-03-20", "risk_appetite": "moderate", "risk_score": 5.5, "source": "call", "note": "Raises diversification into real assets."},
    {"customer_id": 1, "assessed_date": "2024-09-01", "risk_appetite": "moderate", "risk_score": 5.0, "source": "review", "note": "Annual review: gradual de-risking."},
    {"customer_id": 1, "assessed_date": "2025-01-15", "risk_appetite": "moderate", "risk_score": 5.0, "source": "call", "note": "Caution rising; explores collectibles."},
    {"customer_id": 1, "assessed_date": "2025-11-10", "risk_appetite": "conservative", "risk_score": 4.5, "source": "call", "note": "Prioritises capital preservation."},
]
